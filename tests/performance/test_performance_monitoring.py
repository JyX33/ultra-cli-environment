...
class TestPerformanceMonitoring:
    ...
    def test_performance_threshold_validation(self, performance_monitor):
        ...
        assert performance_monitor.check_thresholds()

        # Test exceeding response time threshold
        with performance_monitor.measure_response_time():
            time.sleep(2.5)  # 2500ms - exceeds threshold

        assert not performance_monitor.check_thresholds()
...
class TestPerformanceRegression:
    ...
    def test_regression_detection(self):
        ...
        assert not detector.detect_regression(current_metrics, tolerance=0.15)
        ...
        assert detector.detect_regression(regression_metrics, tolerance=0.15)
    ...
    def test_performance_improvement_detection(self):
        ...
        assert not detector.detect_regression(improved_metrics, tolerance=0.15)
