...
class PerformanceMonitor:
    ...
    def set_thresholds(self, max_response_time_ms: int, max_memory_mb: int, max_api_calls: int):
...
class BenchmarkSuite:
    ...
    def benchmark_reddit_api(self, reddit_service, iterations: int = 5) -> Dict[str, Any]:
    ...
    def benchmark_concurrent_processing(self, subreddits, topic: str, reddit_service, iterations: int = 3) -> Dict[str, Any]:
        """Benchmark concurrent subreddit processing."""
        from app.utils.relevance import score_and_rank_subreddits_concurrent, score_and_rank_subreddits
    ...
    def benchmark_memory_efficiency(self, post_id: str, reddit_service, iterations: int = 3) -> Dict[str, Any]:
    ...
    def benchmark_end_to_end(self, topic: str, subreddit: str, reddit_service, iterations: int = 2) -> Dict[str, Any]:
...
class PerformanceRegression:
    ...
    def set_performance_requirements(self, requirements: Dict[str, float]):
